      ...
      children: [
        ...
        !appleLogin
            ? Padding(
                ...
                child: Row(
                  mainAxisAlignment: author.phone == null || author.phone == ''
                      ? MainAxisAlignment.center
                      : MainAxisAlignment.spaceBetween,
                  children: [
                    //Phone
                    Visibility(
                      visible: author.phone == null || author.phone == ''
                          ? false
                          : true,
                      child: ElevatedButton(
                        style: ButtonStyle(
                        ...
                        onPressed: () async {
                          if (author.phone == null || author.phone == '') {
                            ...
                            final Uri launchUri =
                                Uri(scheme: 'tel', path: author.phone);
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () async {
                        if (author.phone != null && author.phone != '') {
                          final Uri launchUri =
                              Uri(scheme: 'sms', path: author.phone);

                          await launchUrl(launchUri);
                        } else {
                          final Uri launchUri =
                              Uri(scheme: 'mailto', path: author.email);
