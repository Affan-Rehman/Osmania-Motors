      ...
      children: [
        SizedBox(
          ...
          child: Row(
            ...
            children: [
              Spacer(), // This pushes the "Most Recent" text to the center
              Text(
                'Most Recent',
              ...
              TextButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ViewAllRecently(
                        mainPage: mainPage,
                      ),
                    ),
                  );
        ...
        SizedBox(
          ...
          child: ListView.separated(
            ...
            itemCount:
                mainPage.recent.length > 20 ? 20 : mainPage.recent.length,
            separatorBuilder: (BuildContext context, int index) =>
                const Divider(
              thickness: 1.5,
            ),
            itemBuilder: (BuildContext context, int index) {
              var item = mainPage.recent[index];
              return Container(
...
class ViewAllRecently extends StatelessWidget {
  const ViewAllRecently({Key? key, required this.mainPage}) : super(key: key);
